  ...
  return (
    <div className="min-h-screen bg-background ">
      ...
      <div className="lg:hidden">
        ...
        <MobilePanel title="Menu Setup" subtitle="Core information">
        ...
        <div className="mb-3 mt-4 flex gap-2 overflow-x-auto pb-1">
          ...
          <button className="flex shrink-0 items-center gap-1 rounded-full border border-dashed border-border px-4 py-2 text-sm text-muted-foreground">
        ...
        <div className="relative mb-3">
          ...
          <input
            ...
            className="h-11 w-full rounded-lg border border-border bg-muted pl-10 pr-3 text-sm outline-none focus:border-primary"
          />
        </div>

        <div className="space-y-3">
          {filteredItems.map((item) => (
            <div key={item.name} className="glass-card rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button className="-mr-1 -mt-1 rounded-lg p-2 text-muted-foreground">
                  ...
                  <div className="mt-3 flex items-center justify-between gap-3">
                    <input
                      ...
                      className="h-9 w-24 rounded-lg border border-border bg-muted px-3 text-sm outline-none focus:border-primary"
                    />
                    <span
                      className={cn(
          ...
          <button className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-border px-4 py-3 text-sm text-muted-foreground">
            <Plus className="h-4 w-4" />
        ...
        <div className="mt-4 space-y-4">
          <MobilePanel
            title="Availability & Channels"
            subtitle="Choose where this menu can be sold."
          >
            <div className="space-y-2">
              {channels.map((channel) => (
                ...
                >
                  ...
                  <span
                    className={cn(
                      "h-5 w-9 shrink-0 rounded-full p-0.5",
          ...
          <MobilePanel title="Live Preview" subtitle="Guest-facing menu">
          ...
          <MobilePanel
            ...
            subtitle="Items to consider adding"
          >
            <div className="space-y-3">
          ...
          <MobilePanel
            ...
            subtitle="Ready before activation"
          >
            <div className="space-y-3">
        ...
        <div className="sticky bottom-0 z-10 mt-6 -mx-4 flex items-center gap-2 border-t border-border bg-background/95 px-4 py-3 backdrop-blur">
          <button className="flex items-center gap-2 rounded-lg border border-border px-4 py-2.5 text-sm">
          ...
          <button className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground">
...
function MobileMetric({ title, value, icon: Icon, tone }) {
  const tones = {
...
function MobilePanel({ title, subtitle, defaultOpen = false, children }) {
